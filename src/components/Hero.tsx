    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        <p className="text-xl md:text-2xl mb-4 max-w-3xl mx-auto leading-relaxed opacity-90">
          Transform your events with cutting-edge AI technology
        </p>
        
        <p className="text-lg mb-8 max-w-2xl mx-auto opacity-80">
          Instant AR filters, custom branding, QR sharing & professional printing. 
          Perfect for weddings, corporate events, and celebrations across KL & Selangor.
        </p>
